/*
 * Rule: API05-C
 * Source: hand-authored (see below)
 ...
 * the compiler validate/optimize on that guarantee), yet an earlier fix's
 ...
 * is the synthetic fixture an earlier fix calls for: a hand-written, fully
