...
pub struct Dcl05C {
    ...
    /// one.
    pointer_typedef_names: RefCell<HashSet<String>>,
}

impl Dcl05C {
    pub fn new() -> Self {
        Self {
            pointer_typedef_names: RefCell::new(HashSet::new()),
        }
    }
}
...
impl CertRule for Dcl05C {
    ...
    fn check(&self, node: &Node, source: &str) -> Vec<RuleViolation> {
        ...
        let mut known_pointer_typedefs = self.pointer_typedef_names.borrow().clone();
