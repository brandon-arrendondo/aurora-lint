...
impl RuleRegistry {
    ...
    pub fn new() -> Self {
        ...
        registry.register(Box::new(dcl05_c::Dcl05C::new()));
        ...
        registry.register(Box::new(exp14_c::Exp14C::default()));
        registry.register(Box::new(exp15_c::Exp15C));
        registry.register(Box::new(exp19_c::Exp19C::new()));
        ...
        registry.register(Box::new(exp10_c::Exp10C::new()));
        ...
        registry.register(Box::new(int16_c::Int16C::default()));
