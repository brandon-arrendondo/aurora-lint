/*
 * Rule: MSC13-C
 * Source: raylib src/platforms/rcore_android.c (regression from a
 *         benchmark investigation, 2026-08-28)
 ...
 * variable in the codebase look "never read". Fixed alongside an earlier fix's
