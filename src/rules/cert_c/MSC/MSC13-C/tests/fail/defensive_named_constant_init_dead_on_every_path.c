/*
 * Rule: MSC13-C
 * Source: mbedtls library/ (real-world regression)
 ...
 * observed, so it is a dead store whatever it names. An earlier fix exempted
 * this shape outright; an earlier fix narrowed the question to dataflow.
 */
