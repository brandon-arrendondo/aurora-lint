/*
 * Rule: MEM01-C
 * Source: custom (mirrors an EXP33-C shape)
 ...
 *
 * Before an earlier fix, build_read_only_params read that omission as
 ...
 * case in indirect_forward_is_not_a_proven_read.c; the plain
