 ...
 *         from an earlier fix's delta-adjudication
 ...
 * pins the size exactly. An assert stating the capacity contract is no longer
 * among them: see fail/strippable_assert_is_not_a_bound.c.
 */
