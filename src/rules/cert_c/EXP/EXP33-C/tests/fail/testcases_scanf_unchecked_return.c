/*
 * Rule: EXP33-C
 * Source: real-world (hostap wpa_supplicant/eapol_test.c:1042/1044 recall regression)
 ...
 * match leaves some of the variadic outputs uninitialized. An earlier fix
 ...
 * -- flagged before an earlier fix, silently missed after, restored here.
 */
